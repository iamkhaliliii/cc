          ...
          <div className="text-sm text-blue-800">
            ...
            <div className="space-y-2">
              ...
              <div className="pt-2 border-t border-blue-200">
                ...
                <p className="text-xs">روی &ldquo;ذخیره&rdquo; کلیک کنید و QR را در گالری ذخیره کنید. بعداً می‌توانید تصویر را به فروشنده نشان دهید.</p>
              </div>

              <div className="pt-2 border-t border-blue-200">
                <p className="font-medium mb-1">📤 ارسال به دیگران:</p>
                <p className="text-xs">از دکمه &ldquo;اشتراک&rdquo; برای ارسال QR به فروشگاه از قبل استفاده کنید.</p>
              </div>
            </div>
          </div>
        </div>
