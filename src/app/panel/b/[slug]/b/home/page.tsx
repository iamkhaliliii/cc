        ...
        <div className="fixed inset-0 z-30">
          ...
          <div className={`fixed top-0 right-0 bottom-0 w-80 bg-white shadow-2xl z-40 transition-transform duration-300 ease-out ${
            ...
            <div className="p-4 space-y-1 overflow-y-auto h-[calc(100vh-140px)]">
              ...
              <div>
                <button 
                  onClick={() => setExpandedMenu(expandedMenu === 'reports' ? null : 'reports')}
                  className="w-full text-right px-4 py-3 hover:bg-emerald-50 rounded-lg transition-colors flex items-center justify-between group"
                >
                  ...
                  <svg className={`w-4 h-4 text-slate-400 transition-transform ${expandedMenu === 'reports' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
                {expandedMenu === 'reports' && (
                  <div className="mr-8 mt-1 space-y-1">
                    <button className="w-full text-right px-4 py-2 hover:bg-emerald-50 rounded-lg text-sm text-slate-600">
                      گزارش امتیازات
                    </button>
                    <button className="w-full text-right px-4 py-2 hover:bg-emerald-50 rounded-lg text-sm text-slate-600">
                      گزارش کاربرها
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-slate-700">تنظیمات</span>
                  </div>
                  <svg className={`w-4 h-4 text-slate-400 transition-transform ${expandedMenu === 'settings' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
              ...
              <div>
                <button 
                  onClick={() => setExpandedMenu(expandedMenu === 'marketing' ? null : 'marketing')}
                  className="w-full text-right px-4 py-3 hover:bg-emerald-50 rounded-lg transition-colors flex items-center justify-between group"
                >
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-slate-600 group-hover:text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-sm font-medium text-slate-700">مارکتینگ</span>
                  </div>
                  <svg className={`w-4 h-4 text-slate-400 transition-transform ${expandedMenu === 'marketing' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
